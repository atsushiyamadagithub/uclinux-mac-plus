...
2. Run **buildntvfs.sh** to build the root filesystem disk image. The resulting image file is root.img.<br>
Since the installer places the ext2 filesystem starting at sector 16,<br> the loop device is created with an offset of 16 × 512 bytes before running mkfs.ext2:<br>
