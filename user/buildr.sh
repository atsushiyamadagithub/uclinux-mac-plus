...
touch "${ROOTDIR}/dev/@console,c,5,1"
touch "${ROOTDIR}/dev/@null,c,1,3"
touch "${ROOTDIR}/dev/@mem,c,1,1"
touch "${ROOTDIR}/dev/@kmem,c,1,2"
touch "${ROOTDIR}/dev/@ram0,b,1,0"
touch "${ROOTDIR}/dev/@rom0,b,31,0"
touch "${ROOTDIR}/dev/@tty,c,5,0"
touch "${ROOTDIR}/dev/@tty0,c,4,0"
touch "${ROOTDIR}/dev/@ttyS0,c,4,64"
...
makebb ls "${ROOTDIR}/bin/"
makebb uname "${ROOTDIR}/bin/"
makebb echo "${ROOTDIR}/bin/"
